...
```{r}
dirty$department
dirty$department <- tolower(dirty$department)
dirty$department <- gsub(' ', '', dirty$department)
dirty$department[4] <- "geology"
```
...
dirty$department <- as.factor(dirty$department)
dirty$enrollment <- as.factor(dirty$enrollment)
